...
CREATE TABLE `sandbox` (
  ...
  `streaming_key` char(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `streaming_read_key` char(32) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `active_tab` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `active_cursor` int(11) NOT NULL DEFAULT 0,
  `revision` int(11) DEFAULT '1',
